...
namespace Grcs\TorBundle\Lib\TorControl;

/**
 * Class TorControl
 *
 * @package Grcs\TorBundle\Lib\TorControl
 */
class TorControl
{
    /**
    ...
    public function connect()
    {
        ...
        $this->socket = @fsockopen($this->options['hostname'], $this->options['control_port'], $errno, $errstr, $this->options['timeout']);
